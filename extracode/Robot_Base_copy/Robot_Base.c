...
#define FREQ 10000L // We need the ISR for timer 1 every 10 us
...
void __ISR(_TIMER_1_VECTOR, IPL5SOFT) Timer1_Handler(void)
{
	...
	if(ISR_cnt>=2000)
	{
		...
		LATAbits.LATA3 = 1;
		LATAbits.LATA2 = 1; // for now change to pin 9
	}
}
...
void ConfigurePins(void)
{
	...
	ANSELBbits.ANSB0 = 0;  // Make sure RB0 is in digital mode
...
{	
   ...
   //Motor 1 Forwards
	RPB3Rbits.RPB3R = 0x0005;  // Map OC1 function to RB3 (pin 7)

    // Map OC2 to RPB4 for Motor1 PWM output (unchanged)
	 //Motor 1 Backwards
	RPB2Rbits.RPB2R = 0x0006;  // OC2 function motor 2

	// --- New mappings for additional motor PWMs ---
	// Map OC3 to RPB2 for Motor2 PWM output (pin 6)
	 //Motor 2 Forwards
	 // 					  // OC3 function 
	 RPB0Rbits.RPB0R = 0x7; // Map OC3 to RB0 (pin4)
  // 0x7 = OC3

    // Map OC4 to RPB0 for Motor2 PWM output (ensure RPB0 is free)
	//Motor 2 Backwards
    RPB0Rbits.RPB0R = 0x0008;  // OC4 function
