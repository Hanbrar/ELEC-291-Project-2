...
/*SERVO PINS CONFIGURATION*/
    ...
    */
        ...
        printf("Speedx: %d, Speedy: %d, Perimeter1: %.2f, Perimeter2: %.2f, Inductor: %.2f\r\n", speedx, speedy, Perimeter1, Perimeter2, Inductor);
        ...
        if(button_coin == 1){
            ...
            for(ISR_pwm6 = 200; ISR_pwm6 >= 100;ISR_pwm6--){
				waitms(10);
			}
            ...
            for(ISR_pwm5 = 200; ISR_pwm5 <= 240;ISR_pwm5++){
				waitms(10);
			}
            waitms(500);
			state = 4;
            ...
            for(ISR_pwm6 = 100; ISR_pwm6 <= 180;ISR_pwm6++){
				waitms(10);
			}
            ...
            for(ISR_pwm5 = 240; ISR_pwm5 >= 60;ISR_pwm5--){
				waitms(10);
			}
            LATAbits.LATA0 = 0;
            waitms(3000);
