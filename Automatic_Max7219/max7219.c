...
// // MAX7219 Definitions
// #define CS LATBbits.LATB0 // Chip Select (RB0)

// // MAX7219 face displays
// const uint16_t HAPPY_FACE[] = {
//     0x013C, 0x0242, 0x03A5, 0x0481, // Rows 1-4: Customize pattern as needed
//     0x0581, 0x06A5, 0x0742, 0x083C  // Rows 5-8
// };

// const uint16_t SAD_FACE[] = {
//     0x013C, 0x0242, 0x03A5, 0x0481, // Rows 1-4 (customize as needed)
//     0x0599, 0x0666, 0x0742, 0x083C  // Rows 5-8 (frown mouth)
// };

// const uint16_t NEUTRAL_FACE[] = {
//     0x013C, 0x0242, 0x03A5, 0x0481, // Rows 1-4
//     0x05FF, 0x0681, 0x0742, 0x083C  // Rows 5-8 (straight mouth)
// };

// // Initialize SPI for MAX7219
// void SPI_Init() {
//     SPI1CON = 0; // Reset SPI1
//     SPI1BRG = 0; // Max clock speed (adjust if needed)
...
//     MAX7219_Write(0x0A0F); // Set brightness (0x00-0x0F)
//     MAX7219_Write(0x0900); // Disable decoding
...
//                         MAX7219_Write(NEUTRAL_FACE[i]);
//                     }
//                     break;

//                 case BACKWARD:
//                     /*INSERT CODE TO DISPLAY SAD FACE ON MAX 7219*/
//                     for (uint8_t i = 0; i < 8; i++) {
//                         MAX7219_Write(SAD_FACE[i]); // writing sad face
//                     }
...
//                 case COIN_DETECTED:
//                     /*COIN VALUE CALCULATIONS + MAX7219 CODE FOR DISPLAY HAPPY/SAD FACE*/
...
//                     } break;
//             }
//             if (movement_state != COIN_DETECTED && movement_state != BACKWARD) {
//                 for (uint8_t i = 0; i < 8; i++) {
//                     MAX7219_Write(NEUTRAL_FACE[i]);
//                 }
//             }
...
// /* Pinout for DIP28 PIC32MX130 (relevant pins):
//    - RB0  (Pin 4)  → MAX7219 CS
//    - RB11 (Pin 22) → MAX7219 DIN (SPI SDO)
//    - RB14 (Pin 25) → MAX7219 CLK (SPI SCK)
// */
...
// #define DIN     LATBbits.LATB11  // RB11 (SPI SDO, Pin 22)
// #define CLK     LATBbits.LATB14  // RB14 (SPI SCK, Pin 25)
